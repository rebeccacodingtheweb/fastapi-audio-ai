...
class Podcast(beanie.Document):
    ...
    class Settings:
        ...
        indexes = [
            ...
            pymongo.IndexModel(
                keys=[("category", pymongo.ASCENDING)], name="category_ascend"
            ),
            pymongo.IndexModel(
                keys=[("itunes_type", pymongo.ASCENDING)], name="itunes_type_ascend"
            ),
            pymongo.IndexModel(
                keys=[("website_url", pymongo.ASCENDING)], name="website_url_ascend"
            ),
            pymongo.IndexModel(
                keys=[("rss_url", pymongo.ASCENDING)], name="rss_url_ascend"
            ),
        ]
